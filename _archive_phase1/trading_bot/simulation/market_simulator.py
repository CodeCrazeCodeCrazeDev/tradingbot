"""
MarketSimulator - Simulation System
...
def create_market_simulator(config: Optional[Dict] = None) -> MarketSimulator:
    """Factory function to create MarketSimulator instance"""
    return MarketSimulator(config)


if __name__ == "__main__":
    # Test the module
    instance = create_market_simulator()
