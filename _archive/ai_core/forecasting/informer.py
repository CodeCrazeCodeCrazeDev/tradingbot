"""
Informer - Machine Learning System
...
def create_informer(config: Optional[Dict] = None) -> Informer:
    """Factory function to create Informer instance"""
    return Informer(config)


if __name__ == "__main__":
    # Test the module
    instance = create_informer()
