"""
Uncertainty - Machine Learning System
...
def create_uncertainty(config: Optional[Dict] = None) -> Uncertainty:
    """Factory function to create Uncertainty instance"""
    return Uncertainty(config)


if __name__ == "__main__":
    # Test the module
    instance = create_uncertainty()
