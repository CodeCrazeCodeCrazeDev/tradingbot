...
async def demo_constitutional_layer():
    ...
    print(f"  Current NAV: $92,000")
    print(f"  High Water Mark: $100,000")
    print(f"  Drawdown: 8.0%")
    ...
    print(f"  Position Value: $2,500")
    print(f"  Portfolio NAV: $100,000")
    print(f"  Concentration: 2.5%")
    print(f"  [OK] Valid: {is_valid}" if is_valid else f"  [BREACH] {msg}")
    ...
    print(f"  T-Statistic: 2.5")
    print(f"  Sandbox Days: 35")
