...
class RiskManager:
    ...
    def get_risk_report(self) -> str:
        ...
        report = [
            ...
            "\nPosition Limits:",
            *( [f"- {sym}: {limit:.2f}" for sym, limit in summary['limits'].items()] if summary['limits'] else ["- None"] ),
            
            "\nTrading Restrictions:",
            *( [f"- {sym}" for sym in summary['restrictions']] if summary['restrictions'] else ["- None"] ),
        ]
