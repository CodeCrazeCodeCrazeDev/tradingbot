...
class SimpleForecaster:
    ...
    def _forecast_trend(
        ...
        try:
            ...
            logger.error(f"Error in _forecast_trend: {e}")
            raise
    ...
    def _forecast_momentum(
        ...
        try:
            ...
            logger.error(f"Error in _forecast_momentum: {e}")
            raise
    ...
    def _forecast_mean_reversion(
        ...
        try:
            ...
            logger.error(f"Error in _forecast_mean_reversion: {e}")
            raise
    ...
    def _forecast_ensemble(
        ...
        try:
            ...
            logger.error(f"Error in _forecast_ensemble: {e}")
            raise
