...
class PlannerAgent:
    ...
    def _analyze_forecast(self, data: Dict) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _analyze_forecast: {e}")
            raise
    ...
    def _detect_market_regime(self, data: Dict) -> str:
        ...
        try:
            ...
            logger.error(f"Error in _detect_market_regime: {e}")
            raise
    ...
    def _detect_volatility_regime(self, data: Dict) -> str:
        ...
        try:
            ...
            logger.error(f"Error in _detect_volatility_regime: {e}")
            raise
    ...
    def propose_trade(
        ...
        try:
            ...
            logger.error(f"Error in propose_trade: {e}")
            raise
    ...
    def _calculate_kelly(self, win_prob: float, risk_reward: float) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _calculate_kelly: {e}")
            raise
    ...
    def _build_reasoning(self, analysis: Dict, data: Dict, action: str) -> str:
        ...
        try:
            ...
            logger.error(f"Error in _build_reasoning: {e}")
            raise
    ...
    def _check_rate_limit(self):
        ...
        try:
            ...
            logger.error(f"Error in _check_rate_limit: {e}")
            raise
