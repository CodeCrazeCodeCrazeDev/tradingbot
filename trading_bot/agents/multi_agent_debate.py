...
- arXiv:2607.01224 (AutoMem): Epistemic agent memory and dynamic scorecard persistence.
- arXiv:2605.12061 (SAGE): Dynamic knowledge graph-backed multi-agent debate reasoning.
- arXiv:2605.10813 (NanoResearch): Co-evolving agent roles and dynamic contribution scorecards.
- arXiv:2605.20025 (AutoResearchClaw): Multi-round debate loops with self-healing verifier feedback.
- arXiv:2605.17734 (HASP): Non-negotiable financial risk sentinels and hard safety vetoes.
- arXiv:2605.21482 (DeepWeb-Bench): ECE confidence calibration and multi-dimensional debate evaluation.
