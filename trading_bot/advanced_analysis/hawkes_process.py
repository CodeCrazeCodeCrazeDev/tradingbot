...
class HawkesProcessDetector:
    ...
    def calculate_intensity(
        ...
        try:
            ...
            logger.error(f"Error in calculate_intensity: {e}")
            raise
    ...
    def _detect_institutional_pattern(
        ...
        try:
            ...
            logger.error(f"Error in _detect_institutional_pattern: {e}")
            raise
    ...
    def _analyze_clustering(
        ...
        try:
            ...
            logger.error(f"Error in _analyze_clustering: {e}")
            raise
    ...
    def predict_next_event(self, horizon_seconds: float = 60) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error in predict_next_event: {e}")
            raise
