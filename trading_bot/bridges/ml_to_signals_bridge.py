...
class MlToSignalsBridge:
    """Bridge connecting ml to signals subsystem"""
    ...
    async def transfer(self, data: Any) -> Optional[Any]:
        """Transfer data from ml to signals"""
...
def create_bridge(config: Optional[Dict] = None) -> MlToSignalsBridge:
    """Create and return a bridge instance"""
    return MlToSignalsBridge(config)
