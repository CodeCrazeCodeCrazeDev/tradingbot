...
class DecayMetrics:
    ...
    def compute_decay(self):
        ...
        try:
            ...
            logger.error(f"Error in compute_decay: {e}")
            raise
...
class DecayDetector:
    ...
    def compute_decay_velocity(
        ...
        try:
            ...
            logger.error(f"Error in compute_decay_velocity: {e}")
            raise
...
class RegimeMismatchDetector:
    ...
    def detect_mismatch(
        ...
        try:
            ...
            logger.error(f"Error in detect_mismatch: {e}")
            raise
...
class ReplacementSelector:
    ...
    def select_replacement(
        ...
        try:
            ...
            logger.error(f"Error in select_replacement: {e}")
            raise
...
class AlphaDeathClockManager:
    ...
    def create_death_clock(
        ...
        try:
            ...
            logger.error(f"Error in create_death_clock: {e}")
            raise
    ...
    def _generate_alert(
        ...
        try:
            ...
            logger.error(f"Error in _generate_alert: {e}")
            raise
    ...
    def check_auto_retirement(
        ...
        try:
            ...
            logger.error(f"Error in check_auto_retirement: {e}")
            raise
    ...
    def retire(
        ...
        try:
            ...
            logger.error(f"Error in retire: {e}")
            raise
    ...
    def clear_alert(self, alert_id: str):
        ...
        try:
            ...
            logger.error(f"Error in clear_alert: {e}")
            raise
    ...
    def get_alphas_near_death(self, days_threshold: int = 30) -> List[str]:
        ...
        try:
            ...
            logger.error(f"Error in get_alphas_near_death: {e}")
            raise
