...
class RootCauseAnalyzer:
    ...
    def _analyze_drawdown(
        ...
        try:
            ...
            logger.error(f"Error in _analyze_drawdown: {e}")
            raise
    ...
    def _analyze_correlation(
        ...
        try:
            ...
            logger.error(f"Error in _analyze_correlation: {e}")
            raise
    ...
    def _analyze_slippage(
        ...
        try:
            ...
            logger.error(f"Error in _analyze_slippage: {e}")
            raise
    ...
    def _analyze_execution(
        ...
        try:
            ...
            logger.error(f"Error in _analyze_execution: {e}")
            raise
    ...
    def _analyze_signal_drift(
        ...
        try:
            ...
            logger.error(f"Error in _analyze_signal_drift: {e}")
            raise
    ...
    def _generate_actions(
        ...
        try:
            ...
            logger.error(f"Error in _generate_actions: {e}")
            raise
...
class HypothesisGenerator:
    ...
    def _cause_to_string(self, cause: RootCauseType) -> str:
        ...
        try:
            ...
            logger.error(f"Error in _cause_to_string: {e}")
            raise
...
class WeaknessDetectionEngine:
    ...
    def detect_weaknesses(
        ...
        try:
            ...
            logger.error(f"Error in detect_weaknesses: {e}")
            raise
    ...
    def analyze_and_generate_hypothesis(
        ...
        try:
            ...
            logger.error(f"Error in analyze_and_generate_hypothesis: {e}")
            raise
    ...
    def get_detected_weaknesses(self, family_id: Optional[str] = None) -> List[WeaknessDetection]:
        ...
        try:
            ...
            logger.error(f"Error in get_detected_weaknesses: {e}")
            raise
    ...
    def clear_old_weaknesses(self, days: int = 30):
        ...
        try:
            ...
            logger.error(f"Error in clear_old_weaknesses: {e}")
            raise
