...
class PerformanceMonitor:
    ...
    def _check_alerts(
        ...
        try:
            ...
            logger.error(f"Error in _check_alerts: {e}")
            raise
    ...
    def _save_metrics(self, metrics: PerformanceMetrics):
        ...
        try:
            ...
            logger.error(f"Error in _save_metrics: {e}")
            raise
    ...
    def _save_alerts(self, alerts: List[Dict]):
        ...
        try:
            ...
            logger.error(f"Error in _save_alerts: {e}")
            raise
    ...
    def get_current_alerts(
        ...
        try:
            ...
            logger.error(f"Error in get_current_alerts: {e}")
            raise
