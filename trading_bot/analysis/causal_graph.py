...
def create_causal_graph(config: Optional[Dict] = None) -> CausalGraph:
    """Factory function to create CausalGraph instance"""
    return CausalGraph(config)


if __name__ == "__main__":
    # Test the module
    instance = create_causal_graph()
