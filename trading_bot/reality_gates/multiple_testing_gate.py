...
class MultipleTestingGate:
    ...
    def register_test(
        ...
        try:
            ...
            logger.error(f"Error in register_test: {e}")
            raise
    ...
    def correct_results(
        ...
        try:
            ...
            logger.error(f"Error in correct_results: {e}")
            raise
    ...
    def _calculate_deflated_sharpe(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_deflated_sharpe: {e}")
            raise
    ...
    def _min_sharpe_for_significance(
        ...
        try:
            ...
            logger.error(f"Error in _min_sharpe_for_significance: {e}")
            raise
    ...
    def _estimate_false_discovery(
        ...
        try:
            ...
            logger.error(f"Error in _estimate_false_discovery: {e}")
            raise
    ...
    def calculate_overfit_score(
        ...
        try:
            ...
            logger.error(f"Error in calculate_overfit_score: {e}")
            raise
