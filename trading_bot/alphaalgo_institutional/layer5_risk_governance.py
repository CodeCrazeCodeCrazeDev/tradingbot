...
class VaREngine:
    ...
    def compute_parametric_var(
        ...
        try:
            ...
            logger.error(f"Error in compute_parametric_var: {e}")
            raise
    ...
    def compute_historical_var(
        ...
        try:
            ...
            logger.error(f"Error in compute_historical_var: {e}")
            raise
    ...
    def compute_cvar(
        ...
        try:
            ...
            logger.error(f"Error in compute_cvar: {e}")
            raise
...
class DrawdownController:
    ...
    def get_level(self) -> DrawdownLevel:
        ...
        try:
            ...
            logger.error(f"Error in get_level: {e}")
            raise
    ...
    def get_position_limit_multiplier(self) -> float:
        ...
        try:
            ...
            logger.error(f"Error in get_position_limit_multiplier: {e}")
            raise
    ...
    def get_required_action(self) -> RiskAction:
        ...
        try:
            ...
            logger.error(f"Error in get_required_action: {e}")
            raise
...
class TailRiskManager:
    ...
    def estimate_tail_risk(self, returns: np.ndarray) -> Dict[str, float]:
        ...
        try:
            ...
            logger.error(f"Error in estimate_tail_risk: {e}")
            raise
    ...
    def detect_tail_event(self, current_return: float, returns: np.ndarray) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in detect_tail_event: {e}")
            raise
...
class PositionLimitManager:
    ...
    def check_position_limit(
        ...
        try:
            ...
            logger.error(f"Error in check_position_limit: {e}")
            raise
    ...
    def check_concentration(
        ...
        try:
            ...
            logger.error(f"Error in check_concentration: {e}")
            raise
...
class ValidationKillCommittee:
    ...
    def update_risk_state(
        ...
        try:
            ...
            logger.error(f"Error in update_risk_state: {e}")
            raise
    ...
    def _dd_level_to_risk_level(self, dd_level: DrawdownLevel) -> RiskLevel:
        ...
        try:
            ...
            logger.error(f"Error in _dd_level_to_risk_level: {e}")
            raise
    ...
    def _check_halt_conditions(self):
        ...
        try:
            ...
            logger.error(f"Error in _check_halt_conditions: {e}")
            raise
    ...
    def halt_trading(self, reason: str):
        ...
        try:
            ...
            logger.error(f"Error in halt_trading: {e}")
            raise
    ...
    def resume_trading(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in resume_trading: {e}")
            raise
    ...
    def kill_strategy(self, strategy_id: str, reason: str):
        ...
        try:
            ...
            logger.error(f"Error in kill_strategy: {e}")
            raise
