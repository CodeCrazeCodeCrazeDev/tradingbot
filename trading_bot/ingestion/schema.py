...
class ExchangeMetadata:
    ...
    def to_bytes(self) -> bytes:
        ...
        try:
            ...
            _log.getLogger(__name__).error(f"Error in to_bytes: {e}")
            raise
    ...
    def from_bytes(cls, data: bytes) -> tuple['ExchangeMetadata', int]:
        ...
        try:
            ...
            import logging as _log
            _log.getLogger(__name__).error(f"Error in from_bytes: {e}")
            raise
...
class QuoteEvent:
    ...
    def mid_price(self) -> float:
        ...
        try:
            ...
            import logging as _log
            _log.getLogger(__name__).error(f"Error in mid_price: {e}")
            raise
    ...
    def spread(self) -> float:
        ...
        try:
            ...
            import logging as _log
            _log.getLogger(__name__).error(f"Error in spread: {e}")
            raise
    ...
    def spread_bps(self) -> float:
        ...
        try:
            ...
            import logging as _log
            _log.getLogger(__name__).error(f"Error in spread_bps: {e}")
            raise
...
class L2BookSnapshot:
    ...
    def imbalance(self) -> float:
        ...
        try:
            ...
            import logging as _log
            _log.getLogger(__name__).error(f"Error in imbalance: {e}")
            raise
...
class MarketEvent:
    ...
    def add_quality_flag(self, flag: QualityFlag):
        ...
        try:
            ...
            import logging as _log
            _log.getLogger(__name__).error(f"Error in add_quality_flag: {e}")
            raise
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        try:
            ...
            import logging as _log
            _log.getLogger(__name__).error(f"Error in to_dict: {e}")
            raise
    ...
    def checksum(self) -> str:
        ...
        try:
            ...
            import logging as _log
            _log.getLogger(__name__).error(f"Error in checksum: {e}")
            raise
