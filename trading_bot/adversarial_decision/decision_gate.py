...
class GateResult:
    ...
    def get_primary_rejection_reason(self) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Error in get_primary_rejection_reason: {e}")
            raise
...
class DecisionGate:
    ...
    def _check_drawdown_budget(self, portfolio_state: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _check_drawdown_budget: {e}")
            raise
    ...
    def _check_irreversibility(self, market_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _check_irreversibility: {e}")
            raise
    ...
    def _check_correlation_limits(self, portfolio_state: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _check_correlation_limits: {e}")
            raise
    ...
    def _make_decision(
        ...
        try:
            ...
            logger.error(f"Error in _make_decision: {e}")
            raise
...
class EmergencyGate:
    ...
    def check_emergency_conditions(
        ...
        try:
            ...
            logger.error(f"Error in check_emergency_conditions: {e}")
            raise
