...
class ConfidenceVector:
    ...
    def get_weakest_dimension(self) -> str:
        ...
        try:
            ...
            logger.error(f"Error in get_weakest_dimension: {e}")
            raise
...
class ConfidenceCalculator:
    ...
    def calculate_confidence_vector(
        ...
        try:
            ...
            logger.error(f"Error in calculate_confidence_vector: {e}")
            raise
    ...
    def _apply_sample_size_penalty(self, sample_size: int) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _apply_sample_size_penalty: {e}")
            raise
    ...
    def _apply_regime_novelty_decay(self, days_since_seen: int) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _apply_regime_novelty_decay: {e}")
            raise
    ...
    def _apply_alpha_halflife_decay(self, days_since_update: int) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _apply_alpha_halflife_decay: {e}")
            raise
