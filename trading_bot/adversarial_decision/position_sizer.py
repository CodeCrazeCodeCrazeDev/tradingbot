...
class AdversarialPositionSizer:
    ...
    def _calculate_confidence_multiplier(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_confidence_multiplier: {e}")
            raise
    ...
    def _calculate_regime_multiplier(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_regime_multiplier: {e}")
            raise
    ...
    def _calculate_correlation_penalty(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_correlation_penalty: {e}")
            raise
    ...
    def _calculate_loss_fatigue(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_loss_fatigue: {e}")
            raise
    ...
    def adjust_for_gate_decision(
        ...
        try:
            ...
            logger.error(f"Error in adjust_for_gate_decision: {e}")
            raise
