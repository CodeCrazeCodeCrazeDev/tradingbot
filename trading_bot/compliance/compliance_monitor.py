...
class ComplianceMonitor:
    ...
    def check_wash_sale(self, symbol: str, side: str) -> tuple:
        ...
        try:
            ...
            logger.error(f"Error in check_wash_sale: {e}")
            raise
    ...
    def check_market_hours(self) -> tuple:
        ...
        try:
            ...
            logger.error(f"Error in check_market_hours: {e}")
            raise
    ...
    def check_restricted_symbol(self, symbol: str) -> tuple:
        ...
        try:
            ...
            logger.error(f"Error in check_restricted_symbol: {e}")
            raise
    ...
    def check_leverage(self, equity: float, exposure: float) -> tuple:
        ...
        try:
            ...
            logger.error(f"Error in check_leverage: {e}")
            raise
