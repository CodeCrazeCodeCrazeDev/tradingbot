...
class WyckoffICTFusion:
    ...
    def analyze_market_structure(self, 
        ...
        try:
            ...
            logger.error(f"Error in analyze_market_structure: {e}")
            raise
    ...
    def _detect_order_blocks(self, 
        ...
        try:
            ...
            logger.error(f"Error in _detect_order_blocks: {e}")
            raise
    ...
    def _detect_fair_value_gaps(self, 
        ...
        try:
            ...
            logger.error(f"Error in _detect_fair_value_gaps: {e}")
            raise
    ...
    def _detect_liquidity_voids(self, 
        ...
        try:
            ...
            logger.error(f"Error in _detect_liquidity_voids: {e}")
            raise
    ...
    def _detect_wyckoff_phase(self, 
        ...
        try:
            ...
            logger.error(f"Error in _detect_wyckoff_phase: {e}")
            raise
    ...
    def _generate_entry_triggers(self, 
        ...
        try:
            ...
            logger.error(f"Error in _generate_entry_triggers: {e}")
            raise
    ...
    def _check_multi_timeframe_alignment(self, 
        ...
        try:
            ...
            logger.error(f"Error in _check_multi_timeframe_alignment: {e}")
            raise
    ...
    def get_active_order_blocks(self, symbol: str) -> List[OrderBlock]:
        ...
        try:
            ...
            logger.error(f"Error in get_active_order_blocks: {e}")
            raise
    ...
    def get_unfilled_fair_value_gaps(self, symbol: str) -> List[FairValueGap]:
        ...
        try:
            ...
            logger.error(f"Error in get_unfilled_fair_value_gaps: {e}")
            raise
