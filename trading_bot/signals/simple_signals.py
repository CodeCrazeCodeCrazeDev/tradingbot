"""
SimpleSignals - Trading System Component
...
def create_simple_signals(config: Optional[Dict] = None) -> SimpleSignals:
    """Factory function to create SimpleSignals instance"""
    return SimpleSignals(config)


if __name__ == "__main__":
    # Test the module
    instance = create_simple_signals()
