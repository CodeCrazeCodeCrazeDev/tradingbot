...
class TradeScoringSystem:
    ...
    def _determine_grade(self, total_score: float) -> TradeGrade:
        ...
        try:
            ...
            logger.error(f"Error in _determine_grade: {e}")
            raise
    ...
    def _generate_reasoning_summary(
        ...
        try:
            ...
            logger.error(f"Error in _generate_reasoning_summary: {e}")
            raise
    ...
    def get_score_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error in get_score_statistics: {e}")
            raise
    ...
    def get_quality_distribution(self) -> Dict[str, int]:
        ...
        try:
            ...
            logger.error(f"Error in get_quality_distribution: {e}")
            raise
...
def quick_score(
    ...
    try:
        ...
        logger.error(f"Error in quick_score: {e}")
        raise
