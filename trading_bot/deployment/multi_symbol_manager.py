...
class MultiSymbolManager:
    ...
    async def deploy_symbol(self, symbol: str, system_config: Dict):
        ...
        try:
            ...
            logger.error(f"Error in deploy_symbol: {e}")
            raise
    ...
    async def deploy_all_symbols(self, base_config: Dict):
        ...
        try:
            ...
            logger.error(f"Error in deploy_all_symbols: {e}")
            raise
        ...
        try:
            async def generate_for_symbol(symbol):
                try:
                    ...
                    logger.error(f"Error in generate_for_symbol: {e}")
                    raise
            ...
            logger.error(f"Error in generate_signals_parallel: {e}")
            raise
    ...
    def _equal_allocation(self, total_capital: float) -> Dict[str, float]:
        ...
        try:
            ...
            logger.error(f"Error in _equal_allocation: {e}")
            raise
