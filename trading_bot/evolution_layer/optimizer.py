...
class SelfOptimizer:
    ...
    def _optimize_signal_weights(
        ...
        try:
            ...
            logger.error(f"Error in _optimize_signal_weights: {e}")
            raise
    ...
    def _optimize_risk_params(
        ...
        try:
            ...
            logger.error(f"Error in _optimize_risk_params: {e}")
            raise
    ...
    def _optimize_execution_params(
        ...
        try:
            ...
            logger.error(f"Error in _optimize_execution_params: {e}")
            raise
    ...
    def _optimize_position_sizing(
        ...
        try:
            ...
            logger.error(f"Error in _optimize_position_sizing: {e}")
            raise
    ...
    def _generic_optimize(
        ...
        try:
            ...
            logger.error(f"Error in _generic_optimize: {e}")
            raise
    ...
    def _perturb_params(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error in _perturb_params: {e}")
            raise
    ...
    def _validate_params(self, params: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _validate_params: {e}")
            raise
    ...
    def _get_method_name(self, target: OptimizationTarget) -> str:
        ...
        try:
            ...
            logger.error(f"Error in _get_method_name: {e}")
            raise
    ...
    def get_best_params(self, target: OptimizationTarget) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error in get_best_params: {e}")
            raise
