...
def create_twap_executor(config: Optional[Dict] = None) -> TwapExecutor:
    """Factory function to create TwapExecutor instance"""
    return TwapExecutor(config)


if __name__ == "__main__":
    # Test the module
    instance = create_twap_executor()
