...
def create_vwap_executor(config: Optional[Dict] = None) -> VwapExecutor:
    """Factory function to create VwapExecutor instance"""
    return VwapExecutor(config)


if __name__ == "__main__":
    # Test the module
    instance = create_vwap_executor()
