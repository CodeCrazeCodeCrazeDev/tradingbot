"""
PostgresDb - Data Management System
...
def create_postgres_db(config: Optional[Dict] = None) -> PostgresDb:
    """Factory function to create PostgresDb instance"""
    return PostgresDb(config)


if __name__ == "__main__":
    # Test the module
    instance = create_postgres_db()
