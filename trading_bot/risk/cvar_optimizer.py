"""
CvarOptimizer - Risk Management System
...
def create_cvar_optimizer(config: Optional[Dict] = None) -> CvarOptimizer:
    """Factory function to create CvarOptimizer instance"""
    return CvarOptimizer(config)


if __name__ == "__main__":
    # Test the module
    instance = create_cvar_optimizer()
