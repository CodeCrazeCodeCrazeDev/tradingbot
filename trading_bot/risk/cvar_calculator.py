"""
CvarCalculator - Risk Management System
...
def create_cvar_calculator(config: Optional[Dict] = None) -> CvarCalculator:
    """Factory function to create CvarCalculator instance"""
    return CvarCalculator(config)


if __name__ == "__main__":
    # Test the module
    instance = create_cvar_calculator()
