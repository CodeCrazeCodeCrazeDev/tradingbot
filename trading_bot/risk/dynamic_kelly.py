"""
DynamicKelly - Risk Management System
...
def create_dynamic_kelly(config: Optional[Dict] = None) -> DynamicKelly:
    """Factory function to create DynamicKelly instance"""
    return DynamicKelly(config)


if __name__ == "__main__":
    # Test the module
    instance = create_dynamic_kelly()
