...
class StatisticalValidator:
    ...
    def test_positive_expectancy(
        ...
        try:
            ...
            logger.error(f"Error in test_positive_expectancy: {e}")
            raise
    ...
    def test_sharpe_significance(
        ...
        try:
            ...
            logger.error(f"Error in test_sharpe_significance: {e}")
            raise
    ...
    def test_drawdown_bound(
        ...
        try:
            ...
            logger.error(f"Error in test_drawdown_bound: {e}")
            raise
    ...
    def test_consistency_across_seeds(
        ...
        try:
            ...
            logger.error(f"Error in test_consistency_across_seeds: {e}")
            raise
    ...
    def test_no_regime_dependence(
        ...
        try:
            ...
            logger.error(f"Error in test_no_regime_dependence: {e}")
            raise
...
class OODTester:
    ...
    def generate_ood_scenarios(self, level: CurriculumLevel) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error in generate_ood_scenarios: {e}")
            raise
    ...
    def evaluate_ood_performance(
        ...
        try:
            ...
            logger.error(f"Error in evaluate_ood_performance: {e}")
            raise
...
class RobustnessChecker:
    ...
    def check_no_martingale(
        ...
        try:
            ...
            logger.error(f"Error in check_no_martingale: {e}")
            raise
    ...
    def check_no_leverage_abuse(
        ...
        try:
            ...
            logger.error(f"Error in check_no_leverage_abuse: {e}")
            raise
    ...
    def check_no_tail_risk_hiding(
        ...
        try:
            ...
            logger.error(f"Error in check_no_tail_risk_hiding: {e}")
            raise
    ...
    def check_trade_frequency(
        ...
        try:
            ...
            logger.error(f"Error in check_trade_frequency: {e}")
            raise
...
class PromotionEvaluator:
    ...
    def generate_promotion_report(self, result: PromotionResult) -> str:
        ...
        try:
            ...
            logger.error(f"Error in generate_promotion_report: {e}")
            raise
