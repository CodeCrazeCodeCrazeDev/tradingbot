...
class MarketState:
    ...
    def to_observation(self, level: CurriculumLevel) -> np.ndarray:
        ...
        try:
            ...
            logger.error(f"Error in to_observation: {e}")
            raise
...
class LevelConfig:
    ...
    def _default_actions(self) -> List[AgentAction]:
        ...
        try:
            ...
            logger.error(f"Error in _default_actions: {e}")
            raise
...
class PromotionGate:
    ...
    def check_promotion(self, results: List[EpisodeResult]) -> Tuple[bool, List[str]]:
        ...
        try:
            ...
            logger.error(f"Error in check_promotion: {e}")
            raise
...
def get_level_config(level: CurriculumLevel) -> LevelConfig:
    ...
    try:
        ...
        logger.error(f"Error in get_level_config: {e}")
        raise
...
def get_promotion_gate(level: CurriculumLevel) -> PromotionGate:
    ...
    try:
        ...
        logger.error(f"Error in get_promotion_gate: {e}")
        raise
