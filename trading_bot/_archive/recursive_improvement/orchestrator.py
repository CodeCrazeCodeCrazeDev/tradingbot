...
from .harmful_behavior_guard import QwenHarmMonitor, DeepSeekHarmMonitor, ImmutableSafetyFloors
...
class RecursiveImprovementOrchestrator:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.harm_monitor = QwenCodeMenderHarmMonitor(self.config.get('harm_monitor', {}))
