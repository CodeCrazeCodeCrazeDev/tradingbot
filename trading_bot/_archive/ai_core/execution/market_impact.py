...
def create_market_impact(config: Optional[Dict] = None) -> MarketImpact:
    """Factory function to create MarketImpact instance"""
    return MarketImpact(config)


if __name__ == "__main__":
    # Test the module
    instance = create_market_impact()
