...
class PositionSizer:
    ...
    def calculate_fixed_fractional(
        ...
        try:
            ...
            logger.error(f"Error in calculate_fixed_fractional: {e}")
            raise
    ...
    def calculate_volatility_adjusted(
        ...
        try:
            ...
            logger.error(f"Error in calculate_volatility_adjusted: {e}")
            raise
    ...
    def calculate_risk_parity(
        ...
        try:
            ...
            logger.error(f"Error in calculate_risk_parity: {e}")
            raise
...
class PyramidManager:
    ...
    def get_unit_sizes(self, total_size: float) -> List[float]:
        ...
        try:
            ...
            logger.error(f"Error in get_unit_sizes: {e}")
            raise
    ...
    def should_add_unit(
        ...
        try:
            ...
            logger.error(f"Error in should_add_unit: {e}")
            raise
...
class ScaleOutManager:
    ...
    def get_scale_targets(
        ...
        try:
            ...
            logger.error(f"Error in get_scale_targets: {e}")
            raise
    ...
    def should_scale_out(
        ...
        try:
            ...
            logger.error(f"Error in should_scale_out: {e}")
            raise
...
class AdvancedPositionManager:
    ...
    def get_hedge_recommendation(
        ...
        try:
            ...
            logger.error(f"Error in get_hedge_recommendation: {e}")
            raise
...
def get_pyramid_levels(
    ...
    try:
        ...
        logger.error(f"Error in get_pyramid_levels: {e}")
        raise
...
def get_scale_out_targets(
    ...
    try:
        ...
        logger.error(f"Error in get_scale_out_targets: {e}")
        raise
