...
class TrailingStopManager:
    ...
    def should_activate_trailing(
        ...
        try:
            ...
            logger.error(f"Error in should_activate_trailing: {e}")
            raise
...
class PartialProfitTaker:
    ...
    def create_exit_levels(
        ...
        try:
            ...
            logger.error(f"Error in create_exit_levels: {e}")
            raise
    ...
    def check_levels(
        ...
        try:
            ...
            logger.error(f"Error in check_levels: {e}")
            raise
    ...
    def get_breakeven_stop(
        ...
        try:
            ...
            logger.error(f"Error in get_breakeven_stop: {e}")
            raise
...
class AdvancedExitManager:
    ...
    def update_exit_plan(
        ...
        try:
            ...
            logger.error(f"Error in update_exit_plan: {e}")
            raise
    ...
    def calculate_risk_reward(
        ...
        try:
            ...
            logger.error(f"Error in calculate_risk_reward: {e}")
            raise
