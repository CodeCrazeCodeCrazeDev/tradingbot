"""
NbeatsModel - Machine Learning System
...
def create_nbeats_model(config: Optional[Dict] = None) -> NbeatsModel:
    """Factory function to create NbeatsModel instance"""
    return NbeatsModel(config)


if __name__ == "__main__":
    # Test the module
    instance = create_nbeats_model()
