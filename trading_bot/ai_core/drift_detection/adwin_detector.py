...
class ADWINDetector:
    ...
    def add_element(self, value: float) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in add_element: {e}")
            raise
    ...
    def _detect_change(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _detect_change: {e}")
            raise
    ...
    def get_window_mean(self) -> float:
        ...
        try:
            ...
            logger.error(f"Error in get_window_mean: {e}")
            raise
    ...
    def get_window_variance(self) -> float:
        ...
        try:
            ...
            logger.error(f"Error in get_window_variance: {e}")
            raise
...
class ConceptDriftMonitor:
    ...
    def should_retrain(self, window: int = 5) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in should_retrain: {e}")
            raise
    ...
    def get_drift_summary(self) -> dict:
        ...
        try:
            ...
            logger.error(f"Error in get_drift_summary: {e}")
            raise
