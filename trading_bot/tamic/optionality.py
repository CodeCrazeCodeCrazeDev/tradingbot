...
class OptionalityPreservationEngine:
    ...
    def _evaluate_liquidity_value(
        ...
        try:
            ...
            logger.error(f"Error in _evaluate_liquidity_value: {e}")
            raise
    ...
    def _evaluate_irreversibility(
        ...
        try:
            ...
            logger.error(f"Error in _evaluate_irreversibility: {e}")
            raise
    ...
    def _evaluate_opportunity_landscape(
        ...
        try:
            ...
            logger.error(f"Error in _evaluate_opportunity_landscape: {e}")
            raise
    ...
    def _calculate_dry_powder_value(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_dry_powder_value: {e}")
            raise
    ...
    def _evaluate_scenario_flexibility(
        ...
        try:
            ...
            logger.error(f"Error in _evaluate_scenario_flexibility: {e}")
            raise
    ...
    def _calculate_optionality_value(self, metrics: OptionalityMetrics) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _calculate_optionality_value: {e}")
            raise
    ...
    def _get_optionality_value_category(self, value: float) -> OptionalityValue:
        ...
        try:
            ...
            logger.error(f"Error in _get_optionality_value_category: {e}")
            raise
    ...
    def _calculate_recommended_allocation(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_recommended_allocation: {e}")
            raise
    ...
    async def evaluate_optionality(
        ...
        try:
            ...
            logger.error(f"Error in evaluate_optionality: {e}")
            raise
