...
class InstitutionalTimeEngine:
    ...
    def _initialize_calendar(self):
        ...
        try:
            ...
            logger.error(f"Error in _initialize_calendar: {e}")
            raise
    ...
    def _is_in_window(self, target_date: datetime, current_date: datetime, window_days: int) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _is_in_window: {e}")
            raise
    ...
    def _get_active_calendar_flows(self, current_date: Optional[datetime] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error in _get_active_calendar_flows: {e}")
            raise
    ...
    def _detect_flows_from_data(
        ...
        try:
            ...
            logger.error(f"Error in _detect_flows_from_data: {e}")
            raise
    ...
    async def check_institutional_flows(
        ...
        try:
            ...
            logger.error(f"Error in check_institutional_flows: {e}")
            raise
