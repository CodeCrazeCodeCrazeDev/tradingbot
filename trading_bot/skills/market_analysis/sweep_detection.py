...
class SweepDetectionSystem:
    ...
    def _detect_sweeps(
        ...
        try:
            ...
            logger.error(f"Error in _detect_sweeps: {e}")
            raise
    ...
    def _check_buy_sweep(
        ...
        try:
            ...
            logger.error(f"Error in _check_buy_sweep: {e}")
            raise
    ...
    def _check_sell_sweep(
        ...
        try:
            ...
            logger.error(f"Error in _check_sell_sweep: {e}")
            raise
    ...
    def _classify_intensity(
        ...
        try:
            ...
            logger.error(f"Error in _classify_intensity: {e}")
            raise
    ...
    def _check_active_sweep(
        ...
        try:
            ...
            logger.error(f"Error in _check_active_sweep: {e}")
            raise
    ...
    def _find_key_sweep_levels(
        ...
        try:
            ...
            logger.error(f"Error in _find_key_sweep_levels: {e}")
            raise
    ...
    def _determine_post_sweep_bias(
        ...
        try:
            ...
            logger.error(f"Error in _determine_post_sweep_bias: {e}")
            raise
