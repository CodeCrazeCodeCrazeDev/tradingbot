...
class SpeedOfTapeAnalyzer:
    ...
    def _classify_speed(self, tps: float, vps: float) -> TapeSpeed:
        ...
        try:
            ...
            logger.error(f"Error in _classify_speed: {e}")
            raise
    ...
    def _calculate_price_velocity(self, current_price: float) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _calculate_price_velocity: {e}")
            raise
    ...
    def _calculate_price_acceleration(self) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _calculate_price_acceleration: {e}")
            raise
    ...
    def _is_declining(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _is_declining: {e}")
            raise
    ...
    def _calculate_speed_percentile(self, tps: float) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _calculate_speed_percentile: {e}")
            raise
    ...
    def _is_accelerating(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _is_accelerating: {e}")
            raise
    ...
    def _is_climactic(self, tps: float, vps: float) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _is_climactic: {e}")
            raise
    ...
    def _estimate_institutional_activity(
        ...
        try:
            ...
            logger.error(f"Error in _estimate_institutional_activity: {e}")
            raise
