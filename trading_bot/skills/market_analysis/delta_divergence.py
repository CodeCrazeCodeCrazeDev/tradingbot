...
class DeltaDivergenceDetector:
    ...
    def _estimate_buy_sell_volume(
        ...
        try:
            ...
            logger.error(f"Error in _estimate_buy_sell_volume: {e}")
            raise
    ...
    def _build_delta_bars(
        ...
        try:
            ...
            logger.error(f"Error in _build_delta_bars: {e}")
            raise
    ...
    def _determine_delta_trend(self, delta_bars: List[DeltaBar]) -> str:
        ...
        try:
            ...
            logger.error(f"Error in _determine_delta_trend: {e}")
            raise
    ...
    def _detect_divergences(
        ...
        try:
            ...
            logger.error(f"Error in _detect_divergences: {e}")
            raise
    ...
    def _find_nearest_swing(
        ...
        try:
            ...
            logger.error(f"Error in _find_nearest_swing: {e}")
            raise
    ...
    def _calculate_divergence_strength(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_divergence_strength: {e}")
            raise
    ...
    def _find_active_divergence(
        ...
        try:
            ...
            logger.error(f"Error in _find_active_divergence: {e}")
            raise
    ...
    def _calculate_delta_momentum(self, delta_bars: List[DeltaBar]) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _calculate_delta_momentum: {e}")
            raise
    ...
    def _detect_absorption(
        ...
        try:
            ...
            logger.error(f"Error in _detect_absorption: {e}")
            raise
