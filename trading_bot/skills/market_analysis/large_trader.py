...
class LargeTraderDetector:
    ...
    def _estimate_trade_counts(self, volumes: np.ndarray) -> np.ndarray:
        ...
        try:
            ...
            logger.error(f"Error in _estimate_trade_counts: {e}")
            raise
    ...
    def _detect_large_orders(
        ...
        try:
            ...
            logger.error(f"Error in _detect_large_orders: {e}")
            raise
    ...
    def _classify_order_pattern(
        ...
        try:
            ...
            logger.error(f"Error in _classify_order_pattern: {e}")
            raise
    ...
    def _is_hidden_order(
        ...
        try:
            ...
            logger.error(f"Error in _is_hidden_order: {e}")
            raise
    ...
    def _classify_volume(
        ...
        try:
            ...
            logger.error(f"Error in _classify_volume: {e}")
            raise
    ...
    def _determine_dominant_trader(
        ...
        try:
            ...
            logger.error(f"Error in _determine_dominant_trader: {e}")
            raise
    ...
    def _identify_pattern(
        ...
        try:
            ...
            logger.error(f"Error in _identify_pattern: {e}")
            raise
    ...
    def _calculate_acc_dist_scores(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_acc_dist_scores: {e}")
            raise
    ...
    def _determine_smart_money_direction(
        ...
        try:
            ...
            logger.error(f"Error in _determine_smart_money_direction: {e}")
            raise
    ...
    def _find_block_trade_levels(
        ...
        try:
            ...
            logger.error(f"Error in _find_block_trade_levels: {e}")
            raise
