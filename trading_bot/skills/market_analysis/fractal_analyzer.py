...
class FractalAnalyzer:
    ...
    def _detect_fractals(
        ...
        try:
            ...
            logger.error(f"Error in _detect_fractals: {e}")
            raise
    ...
    def _calculate_fractal_strength(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_fractal_strength: {e}")
            raise
    ...
    def _calculate_fractal_dimension(self, closes: np.ndarray) -> FractalDimension:
        ...
        try:
            ...
            logger.error(f"Error in _calculate_fractal_dimension: {e}")
            raise
    ...
    def _get_support_levels(
        ...
        try:
            ...
            logger.error(f"Error in _get_support_levels: {e}")
            raise
    ...
    def _get_resistance_levels(
        ...
        try:
            ...
            logger.error(f"Error in _get_resistance_levels: {e}")
            raise
    ...
    def _predict_next_fractal(
        ...
        try:
            ...
            logger.error(f"Error in _predict_next_fractal: {e}")
            raise
    ...
    def _calculate_trading_bias(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_trading_bias: {e}")
            raise
    ...
    def add_multi_timeframe_data(
        ...
        try:
            ...
            logger.error(f"Error in add_multi_timeframe_data: {e}")
            raise
    ...
    def get_multi_timeframe_alignment(self) -> MultiTimeframeFractal:
        ...
        try:
            ...
            logger.error(f"Error in get_multi_timeframe_alignment: {e}")
            raise
