...
class HarmonicPatternScanner:
    ...
    def _scan_for_pattern(
        ...
        try:
            ...
            logger.error(f"Error in _scan_for_pattern: {e}")
            raise
    ...
    def _calculate_ratios(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_ratios: {e}")
            raise
    ...
    def _calculate_deviation(self, actual: float, expected_min: float, expected_max: float) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _calculate_deviation: {e}")
            raise
    ...
    def _validate_ratios(self, ratios: List[FibonacciRatio], pattern_type: HarmonicPatternType) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _validate_ratios: {e}")
            raise
    ...
    def _calculate_prz(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_prz: {e}")
            raise
    ...
    def _calculate_targets(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_targets: {e}")
            raise
    ...
    def _calculate_pattern_confidence(self, ratios: List[FibonacciRatio]) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _calculate_pattern_confidence: {e}")
            raise
    ...
    def _calculate_completion(
        ...
        try:
            ...
            logger.error(f"Error in _calculate_completion: {e}")
            raise
    ...
    def get_pattern_description(self, pattern_type: HarmonicPatternType) -> str:
        ...
        try:
            ...
            logger.error(f"Error in get_pattern_description: {e}")
            raise
