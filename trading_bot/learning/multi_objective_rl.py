...
class MultiObjectiveRL:
    ...
    def _normalize_profit(self, pnl: float) -> float:
        ...
        try:
            ...
            logger.error(f"Error in _normalize_profit: {e}")
            raise
    ...
    def update_normalization_stats(self):
        ...
        try:
            ...
            logger.error(f"Error in update_normalization_stats: {e}")
            raise
    ...
    def adapt_objectives(self, market_regime: str):
        ...
        try:
            ...
            logger.error(f"Error in adapt_objectives: {e}")
            raise
    ...
    def pareto_optimization(
        ...
        try:
            ...
            logger.error(f"Error in pareto_optimization: {e}")
            raise
    ...
    def _dominates(self, scores_a: Dict[str, float], scores_b: Dict[str, float]) -> bool:
        ...
        try:
            ...
            logger.error(f"Error in _dominates: {e}")
            raise
    ...
    def get_objective_performance(self) -> Dict[str, float]:
        ...
        try:
            ...
            logger.error(f"Error in get_objective_performance: {e}")
            raise
    ...
    def get_overall_performance(self) -> float:
        ...
        try:
            ...
            logger.error(f"Error in get_overall_performance: {e}")
            raise
    ...
    def auto_tune_objectives(self):
        ...
        try:
            ...
            logger.error(f"Error in auto_tune_objectives: {e}")
            raise
    ...
    def calculate_scalarization(
        ...
        try:
            ...
            logger.error(f"Error in calculate_scalarization: {e}")
            raise
