"""
TaskSampler - Meta-Learning System
...
def create_task_sampler(config: Optional[Dict] = None) -> TaskSampler:
    """Factory function to create TaskSampler instance"""
    return TaskSampler(config)


if __name__ == "__main__":
    # Test the module
    instance = create_task_sampler()
