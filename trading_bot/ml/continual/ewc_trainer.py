"""
EwcTrainer - Machine Learning System
...
def create_ewc_trainer(config: Optional[Dict] = None) -> EwcTrainer:
    """Factory function to create EwcTrainer instance"""
    return EwcTrainer(config)


if __name__ == "__main__":
    # Test the module
    instance = create_ewc_trainer()
