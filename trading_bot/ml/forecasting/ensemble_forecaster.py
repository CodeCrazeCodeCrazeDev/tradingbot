"""
EnsembleForecaster - Machine Learning System
...
def create_ensemble_forecaster(config: Optional[Dict] = None) -> EnsembleForecaster:
    """Factory function to create EnsembleForecaster instance"""
    return EnsembleForecaster(config)


if __name__ == "__main__":
    # Test the module
    instance = create_ensemble_forecaster()
