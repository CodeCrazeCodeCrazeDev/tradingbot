...
def create_meta_learning(config: Optional[Dict] = None) -> MetaLearning:
    """Factory function to create MetaLearning instance"""
    return MetaLearning(config)


if __name__ == "__main__":
    # Test the module
    instance = create_meta_learning()
