"""
OnnxConverter - Machine Learning System
...
def create_onnx_converter(config: Optional[Dict] = None) -> OnnxConverter:
    """Factory function to create OnnxConverter instance"""
    return OnnxConverter(config)


if __name__ == "__main__":
    # Test the module
    instance = create_onnx_converter()
