"""
LocalTrainer - Machine Learning System
...
def create_local_trainer(config: Optional[Dict] = None) -> LocalTrainer:
    """Factory function to create LocalTrainer instance"""
    return LocalTrainer(config)


if __name__ == "__main__":
    # Test the module
    instance = create_local_trainer()
