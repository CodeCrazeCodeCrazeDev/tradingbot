"""
GlobalModel - Machine Learning System
...
def create_global_model(config: Optional[Dict] = None) -> GlobalModel:
    """Factory function to create GlobalModel instance"""
    return GlobalModel(config)


if __name__ == "__main__":
    # Test the module
    instance = create_global_model()
