...
def parse_args():
    """Parse command line arguments"""
    parser = argparse.ArgumentParser(description="Elite Trading System - Survival Edition")
    ...
    parser.add_argument(
        ...
        default="logs/survival_system.log"
    )
...
async def main():
    ...
    logger = logging.getLogger("survival_system")
