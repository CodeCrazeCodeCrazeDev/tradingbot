"""
ModuleMonitor - Trading System Component
...
def create_module_monitor(config: Optional[Dict] = None) -> ModuleMonitor:
    """Factory function to create ModuleMonitor instance"""
    return ModuleMonitor(config)


if __name__ == "__main__":
    # Test the module
    instance = create_module_monitor()
